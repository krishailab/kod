        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-12">
              KodRish protects your product, data, and operations with responsible engineering, secure delivery practices, and transparent collaboration from discovery to launch.
            </p>
