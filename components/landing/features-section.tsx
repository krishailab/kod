...
const features = [
  { number: "01", title: "Industry Automation", description: "Streamline repetitive operations with intelligent workflows, connected systems, and automation built around your industry.", visual: "deploy" },
  { number: "02", title: "AI/ML Solutions", description: "Data analysis, predictive modeling, machine vision, NLP, and practical AI applications that create measurable value.", visual: "ai" },
  { number: "03", title: "Design & Branding", description: "UI/UX design, logos, brand kits, social media creatives, and product experiences people remember.", visual: "collab" },
  { number: "04", title: "Technology Teams", description: "Access frontend, fullstack, QA, DevOps, data, security, mobile, and solution architecture specialists.", visual: "security" },
];
  ...
  return (
    <svg viewBox="0 0 200 160" className="w-full h-full">
      ...
      {[0, 1, 2, 3, 4, 5].map((i) => {
        ...
        const radius = 50;
        const x2 = +(100 + Math.cos(angle) * radius).toFixed(2);
        const y2 = +(80 + Math.sin(angle) * radius).toFixed(2);
        return (
          <g key={i}>
            {/* Connection line */}
            <line
